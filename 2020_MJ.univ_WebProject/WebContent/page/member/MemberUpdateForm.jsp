	...
	%>
	 ...
	 %> 	
			  ...
			  <div class="container">
			    ...
			    <h1 class="mt-4 mb-3"><%=bean.getName()%> 회원
			      <small> 정보 수정 하기</small>
			    </h1>
			    ...
			    <table class="table table-hover">
			    	<form action="MemberUpdateProc.jsp" metod="post">
					  	<thead>
							<tr>
								<td>ID</td>
								<td><%=bean.getId()%></td>
							...
							<tr>
								<td>PW</td>
								<td><input type="password" name="pw" value="<%=bean.getPw() %>"></td>
							</tr>
							<tr>
								<td>Tel</td>
								<td><input type="text" name="tel" value="<%=bean.getTel() %>"></td>
							</tr>
							<tr>
								<td>Email</td>
							...
							<tr>
								...
								<input type="submit" value="회원정보 수정 하기" onclick='member/MemberUpdateProc.jsp'>
					</form>
