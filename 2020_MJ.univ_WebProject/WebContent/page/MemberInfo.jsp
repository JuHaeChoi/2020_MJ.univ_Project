					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu dropdown-menu-right"
							...
							<a class="dropdown-item"
								href="${pageContext.request.contextPath}/page/board/OneRoomBoardList.jsp">원룸</a>
							<a class="dropdown-item"
								href="${pageContext.request.contextPath}/page/board/TwoRoomBoardList.jsp">투룸
								이상</a> <a class="dropdown-item"
								href="${pageContext.request.contextPath}/page/board/ShareRoomBoardList.jsp">쉐어하우스</a>
							<a class="dropdown-item"
								href="${pageContext.request.contextPath}/page/board/BoardingRoomBoardList.jsp">하숙
								및 기타</a>
		...
		<table class="table table-hover">
			...
			<tr>
				<td align="center" colspan="4"><br>
					<button onclick="location.href='member/MemberUpdateForm.jsp'">
						정보수정</button>
					<button onclick="location.href='member/MemberDeleteForm.jsp'">
						탈퇴하기</button></td>
			</tr>
		</table>
	</div>
